...
//		@PostMapping("/updated_student/{email}") // Make sure the path matches the form action
//	    public String updateStudent(
//	            @PathVariable("email") String email,
//	            @ModelAttribute("student") Teacher updatedTeacher
//	    ) {
//	        // Here you can update the student/teacher information using the service
//	        //teacherService.updateTeacher(email, updatedTeacher);
//	        return "redirect:/home"; // Redirect to the desired endpoint after update
//	    }
}
